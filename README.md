...
[![Build Status](https://secure.travis-ci.org/skbkontur/oauth2_proxy.png?branch=master)](http://travis-ci.org/skbkontur/oauth2_proxy)
...
1. Download [Prebuilt Binary](https://github.com/skbkontur/oauth2_proxy/releases) (current release is `v2.1`) or build with `$ go get github.com/skbkontur/oauth2_proxy` which will put the binary in `$GOROOT/bin`
